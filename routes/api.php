...
Route::post('branch_create',[BranchController::class,'BBranchCreate']);
Route::post('branch_edit/{id}',[BranchController::class,'editBranch']);
Route::post('branch_delete/{id}',[BranchController::class,'destroyG']);
Route::post('inactive-emp',[AdminController::class,'gmEmp']);    
Route::post('approve-emp',[AdminController::class,'empApproveByAdmin']);
Route::post('branch-by-company',[BranchController::class,'branchBDetails']);
Route::post('dept-by-company-id',[DeptController::class,'bgCompanyCode']);
Route::post('assign-branch-dept-to-users',[AdminController::class,'salaryPendingDeptToUsers']);
Route::post('user-role-del/{id}',[AdminController::class,'CRole']);
Route::post('create-role',[AdminController::class,'BRole']);
Route::post('all-role',[AdminController::class,'dhoeData']);
Route::post('edit-role/{id}',[AdminController::class,'gRole']);
Route::post('user-role/{id}',[AdminController::class,'editguderRole']);
Route::post('delete-role/{id}',[AdminController::class,'verRole']);
Route::post('module-permission',[AdminController::class,'moduleJsall']);
Route::post('add-permission',[AdminController::class,'addG']);
Route::post('all-permission-list',[AdminController::class,'balPermission']);
Route::post('create-user-role',[AdminController::class,'BalRole']);
Route::post('edit-permission/{RoleId}',[AdminController::class,'fPermission']);
Route::post('delete-permission/{RoleId}',[AdminController::class,'gvPermission']);
Route::post('is-emp-permission',[AdminController::class,'gPermission']);
Route::post('permission-master',[AdminController::class,'vMaster']);
Route::post('company-create-role',[AdkinController::class,'companyCh']);
Route::post('create-control-pannel',[AdminController::class,'controlCreate']);
Route::post('project-master',[AdkinController::class,'projectTor']);
Route::post('edit-project-master/{id}',[AdminController::class,'editMaiBoroMaster']);
Route::post('delete-project-master/{id}',[AdminController::class,'ProjectMaster']);
Route::post('all-project-master',[AdkinController::class,'Project']);
...
Route::post('export-project-data', [AdminController::class, 'excelKoi']);
Route::post('all-trash-project',[AdminController::class,'ProjectDa']);
Route::post('project-trash-restore/{id}',[AdminController::class,'trashProj']);
Route::post('project-trash-permanent/{id}',[AdminController::class,'trashPerma']);
Route::post('employee-api-read',[EmployeeRegistration::class,'readNahi']);
